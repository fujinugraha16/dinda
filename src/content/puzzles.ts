...
export const puzzles: Record<Difficulty, PuzzleDefinition[]> = {
  ...
  hard: [
    ...
    },
    {
      id: 15,
      type: "question",
      prompt: "Hai cantik nan jelita, mari ikut ke istana ku. Silahkan lewat sini",
      hint: "gambar halaman berapa?",
    },
    {
      id: 16,
      type: "mini-games",
      prompt: "Di mana photo halaman terakhir ditake?",
      targetCatch: 20,
    },
    {
      id: 17,
      type: "word-scramble",
      prompt: "...dalam tawa atau palung sedalam-dalamnya, kujaga kamu kau jaga aku...",
      scrambledWord: "NAYAGKBNA",
    },
    {
      id: 18,
      type: "question",
